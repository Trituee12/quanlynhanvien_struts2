          ...
          <section class="wrapper ">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel ">
                      ...
                      <form class="form-horizontal style-form" action="editde"   method="POST" >
                          
                              <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Mã phòng ban</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control round-form" name="maphong" value="${pb.maphong}" readonly="" required="">
                              </div>
                          </div>
                         <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tên phòng ban</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control round-form" name="tenphong" value="${pb.tenphong}" required="">
                              </div>
                          </div>
                          <div style="text-align: center">
                              <input type="submit" class="btn btn-primary" value="Thêm"/></div> 
