						...
						<div class="col-lg-12 col-md-12 col-sm-12 mb">
							<!-- WHITE PANEL - TOP USER -->
                              ...
                              <table  class="table"   id="myTable">
		                          ...
		                          <thead>
		                          <tr style="color : navy"> 
		                              <th style="text-align: center;font-weight: bold"><s:message code="label.nv.hinhanh"  /></th>
		                          ...
		                          <tbody>
                                              ...
                                              String sql = "SELECT nhanvien.tenhinh, nhanvien.hoten, sum(loai),(select count(loai) from thanhtichkyluat where loai=1 and thanhtichkyluat.manhanvien = nhanvien.manv),(select sum(loai) from thanhtichkyluat where loai=-1 and thanhtichkyluat.manhanvien = nhanvien.manv) from thanhtichkyluat inner join nhanvien where thanhtichkyluat.manhanvien = nhanvien.manv group by manv";
                                              ResultSet rs = st.executeQuery(sql);
                                              while(rs.next()){
                                              %>
                                                  <tr class="trr" style="color: black">
                                                      
                                                      <td style="vertical-align: middle"> <img src="${pageContext.servletContext.contextPath}/assets/core/img/friends/<%=rs.getString(1)%>" width="50" height="50" /></td>
                                                       <td style="vertical-align: middle"><%=rs.getString(2)%></td>
                                                      <td style="vertical-align: middle"><%=rs.getInt(4)%></td>
                                                       <td style="vertical-align: middle"><%=rs.getInt(5)%></td>
