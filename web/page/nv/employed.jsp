      ...
      <header class="header black-bg">
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="${pageContext.servletContext.contextPath}/logOut">Đăng xuất</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
              ...
              <div style="float:left"><h3><i class="fa fa-angle-right "></i><strong>DANH SÁCH NHÂN VIÊN</strong></h3></div>
             
                                <div style="float:right; padding-bottom: 10px"><a href="${pageContext.request.contextPath}/addnv"><h3><button type="button" class="btn btn-theme col-sm-12"><i class="material-icons">person_add</i>&nbsp;&nbsp;Thêm</button></h3></a></div>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 mb">
                          ...
                          <section id="unseen">
                              ...
                              <thead>
                                  ...
                                  <th  style="text-align: center;font-weight: bold">địa chỉ</th>
                                  ...
                                  <th  style="text-align: center;font-weight: bold">Phòng ban</th>
                              ...
                              <tbody>
                                  ...
                                  <td  style="text-align: center; vertical-align: middle"><c:out value="${item.birthday}"></c:out></td>
                                  <td  style="text-align: center; vertical-align: middle"><c:out value="${item.address}"></c:out></td> 
                                  ...
                                  <td  style="text-align: center; vertical-align: middle"> <c:out value="${item.phongban.tenphong}"></c:out></td>
                                  <td  style="text-align: center; vertical-align: middle"> <a href="${pageContext.request.contextPath}/editnv?id=<c:out value="${item.id}"></c:out>" class="btn btn-primary btn-xs"> <i class="fa fa-pencil"></i></a>|
                                   <a href="del?id=<c:out value="${item.id}"></c:out>" class="btn btn-danger btn-xs" " onclick="return confirm('Bạn có chắc chắn xóa?')"> <i class="fa fa-trash-o"></i></a></td>
